...
map.getView().fit([-1402980.139464, 3304972.733627, -567822.257071, 4107566.532348], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement 2024 de la population pour la région Marrakech-Safi (by LBSRAOUI Mohammed)</h2>';
        return titleElement;
    })(),
